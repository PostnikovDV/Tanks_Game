...
bool Game::init()
{
    ...
    m_pTank = std::make_unique<Tank>(
                                        ResourceManager::getSprite("tankSpriteTop")
                                        , ResourceManager::getSprite("tankSpriteBottom")
                                        , ResourceManager::getSprite("tankSpriteLeft")
                                        , ResourceManager::getSprite("tankSpriteRight")
                                        , 0.0000001f
                                        , glm::vec2(0.f, 0.f)
                                        , glm::vec2(16.f, 16.f));
